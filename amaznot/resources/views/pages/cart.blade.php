...
@section('content')
    ...
    <div class="cart-items">
        ...
        <button  style="border-radius:17px;margin-top:1%;margin-left:2%;" class="btn btn-info" type="button" onclick="empty()" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 3 14 14">
