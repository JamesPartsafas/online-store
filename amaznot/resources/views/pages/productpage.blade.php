  ...
  <form  method='post'>
    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
      ...
      <div id='add-controls'>
        ...
        <input type='text'  id="{{ $product['id'] }}" value="1"  size='1' style="text-align:center;border-radius: 4px;" disabled >
        ...
        <button  style="border-radius: 4px;" class="btn btn-primary" type="button" onclick="addToCart({{ $product['id'] }}, renderScreen)" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 3 14 14">
